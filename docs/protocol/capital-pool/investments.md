...
Any investment allocations are decided by members through the Mutual's [governance process](/governance) using the [Investment Proposal Template](https://forum.nexusmutual.io/t/investment-proposal-template/1096/1) outlined on the governance forum. To date, members have voted to allocate Capital Pool assets in the following strategies.
...
This position was exited in 2025 and re-allocate to the Morpho investment noted below.
...
## Lend 5,160 ETH via the Morpho Steakhouse ETH Vault on Ethereum

In September 2025, the Morpho team shared an [RFC](https://forum.nexusmutual.io/t/rfc-proposal-eth-lending-via-morpho/1805) on the forum, where they outlined a proposal to allocate 5,160 ETH from the Mutual's Enzyme vault to a Morpho Vault, with a few provided examples in the proposal. The community expressed support for this proposal, with a preference to allocate the funds to the [Steakhouse ETH Morpho Vault](https://app.morpho.org/ethereum/vault/0xBEEf050ecd6a16c4e7bfFbB52Ebba7846C4b8cD4/steakhouse-eth#overview). This proposal transitioned to an [NMPIP](https://forum.nexusmutual.io/t/nmpip-eth-lending-via-morpho/1809), which was approved through a community vote on Snapshot: [NMPIP: Lend 5,160 ETH via the Morpho Steakhouse ETH Vault on Ethereum](https://snapshot.box/#/s:community.nexusmutual.eth/proposal/0x94275866a2650857efcbc22a0dc127c4a7680dac1e676ad66113d0a784c191ab).

You can review this position in the Nexus Mutual Enzyme vault noted below.
...
[The Enzyme Finance vault has a dashboard](https://app.enzyme.finance/vault/0x27f23c710dd3d878fe9393d93465fed1302f2ebd) that tracked the initial Capital Pool allocation to the M11 Credit WETH lending pool on Maple Finance. The funds were withdrawn from the M11 Credit WETH pool in February 2023 and now, the Mutual manages a portion of the Capital Pool investments, as noted above, in this vault. Anyone can review the financial performance of the vault, movement/deployment of funds through the vault, and earnings over time.