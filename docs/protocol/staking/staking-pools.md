...
When a pool is first created, the maximum management fee must be set below 100%. Once the maximum fee is set at creation, it stays fixed for the life of the pool, though the fee can be adjusted up to the maximum.
