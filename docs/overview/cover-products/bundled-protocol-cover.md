...
For more information, read the full terms and conditions of [Nexus Mutual's Multi Protocol Cover](https://api.nexusmutual.io/v2/ipfs/QmW8KieoRvbuLdycqCq2PiwAbJrAABk8uMwHypFoTypNQ4).

Nexus Mutual's [Claims Committee](/protocol/claims-assessment#expert-led-claim-assessment) use this cover wording as a reference when considering any Multi Protocol Cover claim.
