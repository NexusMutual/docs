...
When you run ETH validators and have active ETH Slashing Umbrella Cover, you are protected against losses that occur during the cover period where one or more of the covered validators incur penalties greater than the deductible in any continuous 40 day period.

## ETH Slashing Umbrella Cover wording
...
When an organization purchases ETH Slashing Umbrella Cover, they provide the validator numbers they want covered in a csv file and that list is stored on IPFS.
